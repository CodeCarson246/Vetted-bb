...
<body>
  ${isReceipt ? `<div style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-22deg);border:7px solid #16a34a;color:#16a34a;padding:14px 44px;border-radius:16px;text-align:center;line-height:1;opacity:0.22;pointer-events:none;z-index:0">
