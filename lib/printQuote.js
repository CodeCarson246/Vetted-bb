...
<body>
  ...
  <table width="100%">
    <tr><td style="border-top:1px solid #e5e7eb;padding-top:16px;text-align:center">
      ...
      ${quote.verify_code ? `<div style="font-size:11px;color:#6b7280;margin-top:6px">Verify this document at <span style="color:#00267F;font-weight:600">${esc(SITE_HOST)}/verify</span> with code <span style="font-family:monospace;font-weight:700;color:#111827;letter-spacing:1px">${esc(formatVerifyCode(quote.verify_code))}</span></div>` : ''}
    </td></tr>
  </table>
