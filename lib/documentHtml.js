...
<style>
  * { box-sizing:border-box; margin:0; padding:0; -webkit-print-color-adjust:exact !important; print-color-adjust:exact !important; }
  body { font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif; background:white; color:#111827; position:relative; font-size:13px; line-height:1.45; }
  .sora { font-family:'Sora','Inter',sans-serif; }
  table { border-collapse:collapse; }
  /* No body padding in print: the page margin is the only margin. Body
     padding on top of it is what pushed a short document's footer onto
     page 2. Design to iPhone Safari's page, the tightest one we print to:
     it ignores @page margin and uses its own 0.75in, leaving 650x978 CSS px
     on A4 (desktop Chrome honours 1.2cm and gets 703x1032). */
